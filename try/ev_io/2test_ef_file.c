...
int main()
{
	...
	for (int i = 0; i < 50 ; i++) {
		...
		//write_fd[i] = ef_open(file_name,O_WRONLY|O_CREAT|O_APPEND, S_IRUSR+S_IWUSR+S_IRGRP+S_IROTH);
		//write_fd[i] = ef_open(file_name,O_WRONLY|O_CREAT, S_IRUSR+S_IWUSR+S_IRGRP+S_IROTH);
		//write_fd[i] = ef_open(file_name,O_RDWR|O_CREAT|O_APPEND, S_IRUSR+S_IWUSR+S_IRGRP+S_IROTH);
		write_fd[i] = ef_open(file_name,O_RDWR|O_CREAT, S_IRUSR+S_IWUSR+S_IRGRP+S_IROTH);
	}
